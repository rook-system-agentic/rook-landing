...
const plans: Plan[] = [
  {
    ...
    disabled: false,
    features: [
      "Calculadora básica de compras (CMV)",
      "1 estabelecimento",
      "Até 8 cálculos/mês",
      "1 diagnóstico parcial/mês",
      "Benchmark resumido",
      "Suporte por email",
    ],
    cta: "Começar Grátis",
  ...
  },
  {
    ...
    features: [
      "Tudo do Pawn",
      "Até 25 cálculos de compras/mês",
      "5 diagnósticos completos/mês",
      "Resultado automático (DRE)",
  ...
  },
  {
    ...
    features: [
      "Tudo do Knight",
      "Cálculos e diagnósticos ilimitados",
      "Projeções e cenários",
      "Relatórios personalizados",
      "Integração ERP (Omie, Conta Azul)",
