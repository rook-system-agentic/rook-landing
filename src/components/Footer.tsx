    ...
    <footer className="border-t" style={{ borderColor: "var(--color-border)", backgroundColor: "var(--color-bg)" }}>
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="md:col-span-1">
          <Link href="/" className="inline-block mb-4">
            <Image src="/brand/rook-logo-horizontal-light.png" alt="Rook System" width={140} height={47} className="h-10 w-auto dark:hidden" />
            <Image src="/brand/rook-logo-horizontal.png" alt="Rook System" width={140} height={47} className="h-10 w-auto hidden dark:block" />
          </Link>
      ...
      <div className="border-t border-border">
        <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-muted">&copy; 2026 {COMPANY_INFO.razaoSocial}. CNPJ {COMPANY_INFO.cnpj}. Todos os direitos reservados.</p>
          <div className="flex items-center gap-4">
            <a href="https://www.linkedin.com/company/rooksystem" target="_blank" rel="noopener" className="text-muted hover:text-cream transition-colors" aria-label="LinkedIn">
              <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
            </a>
            <a href="https://www.instagram.com/rooksystem" target="_blank" rel="noopener" className="text-muted hover:text-cream transition-colors" aria-label="Instagram">
