...
export default function LpPricing() {
 return <section className="lp-band py-20 lg:py-28" aria-labelledby="capture-title" style={{borderTop:"1px solid var(--lp-line)"}}>
  <div className="mx-auto max-w-3xl px-6 text-center">
   ...
   <div className="flex flex-wrap justify-center gap-4"><Link href="#cadastro" className="btn-primary">{ACQUISITION_CTA.formLabel}</Link><a href="#data-asaflow-chat-open" data-asaflow-chat-open className="btn-ghost">{ACQUISITION_CTA.chatLabel}</a></div>
  </div>
 </section>;
}
