    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 px-6 py-4" style={{ backgroundColor: "var(--color-header-bg)", backdropFilter: "blur(12px)" }}>
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <Link href="/">
            <Image src="/brand/rook-logo-horizontal.png" alt="Rook System" width={120} height={32} className="hidden dark:block" />
            <Image src="/brand/rook-logo-horizontal-light.png" alt="Rook System" width={120} height={32} className="dark:hidden" />
          </Link>
