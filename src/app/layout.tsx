...
export const metadata: Metadata = {
  ...
  title: {
    default: "Rook System — Gestão Financeira para Restaurantes",
    template: "%s | Rook System",
  },
  description:
    "Controle CMV, otimize compras e proteja a margem do seu restaurante. Dados fiscais reais, 100% auditáveis. Faturar não é lucrar — a Rook mostra onde está o dinheiro.",
  keywords: [
    ...
    "gestão restaurante",
    "SaaS restaurante",
    "otimização compras restaurante",
  ],
  ...
  openGraph: {
    ...
    description:
      "Controle CMV, otimize compras e proteja a margem do seu restaurante. Dados fiscais reais, 100% auditáveis.",
    images: [
      {
