...
const sections = [
  ...
  ["6. Cookies", "Utilizamos cookies necessários ao funcionamento e à segurança. Cookies opcionais de medição ou comunicação podem ser usados conforme as preferências disponíveis e a legislação aplicável."],
